...
#     return generate_caption_from_model(model)

# @app.route('/generate_caption_quantized', methods=['POST'])
# def generate_caption_quantized():
#     return generate_caption_from_model(quantized_model)

# def generate_caption_from_model(model_to_use):
#     try:
...
#         return jsonify(caption=captions[0] if captions else "No caption generated")
