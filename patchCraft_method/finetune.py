...
# testing_dataset=pd.read_csv('/scratch/af3954/patchCraft/test_image_labels.csv')
...
class ImageCaptioningDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        rt1,pt1 = smash_n_reconstruct(img_path)
        
        img2=apply_all_filters(rt1)
        img3=apply_all_filters(pt1)
        ...
        encoding = self.processor(images=[image,img2,img3], text=text, padding="max_length", return_tensors="pt")
...
model.save_pretrained("patchCraft_model")
